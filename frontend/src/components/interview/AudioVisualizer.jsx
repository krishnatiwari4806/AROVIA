 ...
 */
export function AudioVisualizer({ isSpeaking = false, isListening = false, isAnalyzing = false }) {
  const isActive = isSpeaking || isListening;

  return (
    <div className={`arovia-waveform-container ${isActive ? 'active' : isAnalyzing ? 'analyzing' : 'idle'}`}>
